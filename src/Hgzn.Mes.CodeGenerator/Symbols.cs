...
namespace Hgzn.Mes.CodeGenerator;
...
public static class Symbols
{
    public static class Namespaces
    {
        ...
        {
            public const string ApiShared = "Hgzn.Mes.Api.Shared";
            public const string DomainShared = "Hgzn.Mes.Domain.Shared";
        }
    }
    ...
    public static class Types
    {
        ...
        public static class Project
        {
            ...
            public const string ErrorInfo = $"{Namespaces.Project.ApiShared}.Error.ErrorInfo";
