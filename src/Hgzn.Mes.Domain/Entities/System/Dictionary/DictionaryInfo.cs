...
namespace Hgzn.Mes.Domain.Entities.System.Dictionary
{
    public class DictionaryInfo : UniversalEntity, ISoftDelete, IOrder, IState, IAudited, ISeedsGeneratable
    {
        ...
        public static DictionaryInfo[] Seeds 
        { 
            get
            {
                List<DictionaryInfo> list = [
                    ...
                    DictionaryType.BaudRate2400,
                    DictionaryType.BaudRate4800,
                    DictionaryType.BaudRate9600,
                    DictionaryType.BaudRate19200,
                    DictionaryType.BaudRate38400,
                    DictionaryType.BaudRate57600,
                    DictionaryType.BaudRate115200,
                    DictionaryType.ABCD,
                    DictionaryType.BADC,
                    DictionaryType.CDAB,
                    DictionaryType.DCBA,
                ...
                list.AddRange(DictionaryType.TestSystemEquipTypes);
                return [.. list];
            }
        }
