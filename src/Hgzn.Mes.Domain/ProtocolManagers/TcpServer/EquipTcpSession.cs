...
namespace Hgzn.Mes.Domain.ProtocolManagers.TcpServer
{
    public class EquipTcpSession : TcpSession
    {
        ...
        public EquipTcpSession(EquipTcpServer server, string heartBeatMessage, string heartBeatAck, int heartTime,
            IMediator mediator, EquipConnect equipConnect) : base(server)
        {
            _heartBeatMessage = heartBeatMessage;
            _heartBeatAck = heartBeatAck;
            this._mediator = mediator;
            this._equipConnect = equipConnect;
            if (equipConnect.ForwardRate != null)
                this._forwardLength = equipConnect.ForwardRate.Value;
        }
