...
namespace Hgzn.Mes.Infrastructure.Mqtt.Topic
{
    public class TopicBuilder
    {
        ...
        public virtual TopicBuilder WithPrefix(TopicType prefix)
        {
            _prefix = prefix;
            return this;
        }
        ...
        public virtual string Build() =>
            new MqttTopic { Direction = _direction, Prefix = _prefix, Tag = _tag }.ToString();
    ...
    public class IotTopicBuilder : TopicBuilder
    {
        ...
        public override IotTopicBuilder WithPrefix(TopicType prefix)
        {
            _prefix = prefix;
            return this;
        }
    ...
    public class UserTopicBuilder : TopicBuilder
    {
        ...
        public override UserTopicBuilder WithPrefix(TopicType prefix)
        {
            _prefix = prefix;
            return this;
        }
