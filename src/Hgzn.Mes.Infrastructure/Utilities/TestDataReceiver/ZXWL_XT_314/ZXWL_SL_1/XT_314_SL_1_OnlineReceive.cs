...
{
    public class XT_314_SL_1_OnlineReceive : XT_314_SL_1_ReceiveBase, IOnlineReceive
    {
        public XT_314_SL_1_OnlineReceive(Guid equipId,
        ...
        public async Task<Guid> Handle(byte[] msg)
        {
            ...
            PropertyInfo[] properties = typeof(XT_314_SL_1_ReceiveData).GetProperties();
            ...
            // 将试验数据记录数据库
            XT_314_SL_1_ReceiveData receive = await _sqlSugarClient.Insertable(entity).ExecuteReturnEntityAsync();
        ...
        private async Task TestDataPublishToMQTT(XT_314_SL_1_ReceiveData receive)
        {
            XT_314_SL_1_TestAnalyseJob job = new XT_314_SL_1_TestAnalyseJob();
        ...
        private static void OutputToLog(XT_314_SL_1_ReceiveData entity)
        {
            return;
            // 输出到日志
            PropertyInfo[] receiveDataProperties = typeof(XT_314_SL_1_ReceiveData).GetProperties();
            string output = "";
