...
{
    public class XT_314_SL_1_TestAnalyseJob
    {
        ...
        public XT_314_SL_1_TestAnalyseJob()
        {
            DivisionTables = InitializeDivisionTables();
        }

        public ApiResponse GetResponse(XT_314_SL_1_ReceiveData receiveData, string formType)
        {
        ...
        public ApiResponse GetResponseForPushData(XT_314_SL_1_ReceiveData receiveData, List<string> tableNames)
        {
            ApiResponse ret = new ApiResponse();
            if (receiveData == null) return ret;
            ret.data = new List<DataArea>();
        ...
        private Dictionary<(string, string), float> Analyse(XT_314_SL_1_ReceiveData receiveData, DivisionTable divisionTable)
        {
