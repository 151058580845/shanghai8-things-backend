...
namespace HgznMes.Domain.Utilities
{
    public static class RequireScopeUtil
    {
        ...
        {
            Scopes = Assembly.Load("HgznMes." + nameof(Application)).GetTypes()
                .Where(type => type.Namespace == "HgznMes." + nameof(Application) + ".Services")
